#### Using AUC but only using models of size 1. Environments on all but Y
...
AUC_res_reg <- c()
AUC_average_reg <- c()
res_AUC_ran_parents_1_env_all <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
res_AUC_ran_parents_1_ell_1_env_all <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
res_AUC_ran_parents_1_reg_env_all <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
...
for (om_H in 1:length(omega_H)) {
  ...
  res_AUC_ran_parents_1_env_all[,om_H] <- AUC_average
  res_AUC_ran_parents_1_ell_1_env_all[,om_H] <- AUC_average_ell_1
  res_AUC_ran_parents_1_reg_env_all[,om_H] <- AUC_average_reg
}
res_AUC_ran_parents_1_env_all
res_AUC_ran_parents_1_ell_1_env_all
res_AUC_ran_parents_1_reg_env_all

saveRDS(object = res_AUC_ran_parents_1_env_all, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_1_env_all.RDS")
saveRDS(object = res_AUC_ran_parents_1_ell_1_env_all, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_1_ell_1_env_all.RDS")
saveRDS(object = res_AUC_ran_parents_1_reg_env_all, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_1_reg_env_all.RDS")
