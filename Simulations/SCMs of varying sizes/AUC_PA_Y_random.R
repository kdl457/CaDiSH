...
AUC_res_reg <- c()
AUC_average_reg <- c()
res_AUC_ran_parents <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
res_AUC_ran_parents_ell_1 <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
res_AUC_ran_parents_reg <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
...
for (om_H in 1:length(omega_H)) {
  ...
  res_AUC_ran_parents[,om_H] <- AUC_average
  res_AUC_ran_parents_ell_1[,om_H] <- AUC_average_ell_1
  res_AUC_ran_parents_reg[,om_H] <- AUC_average_reg
}
res_AUC_ran_parents
res_AUC_ran_parents_ell_1
res_AUC_ran_parents_reg

saveRDS(object = res_AUC_ran_parents, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents.RDS")
saveRDS(object = res_AUC_ran_parents_ell_1, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_ell_1.RDS")
saveRDS(object = res_AUC_ran_parents_reg, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_reg.RDS")
