...
AUC_res_reg <- c()
AUC_average_reg <- c()
res_AUC_ran_parents_1 <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
res_AUC_ran_parents_1_ell_1 <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
res_AUC_ran_parents_1_reg <- matrix(NA, nrow = n_CI, ncol = length(omega_H))
...
for (om_H in 1:length(omega_H)) {
  ...
  res_AUC_ran_parents_1[,om_H] <- AUC_average
  res_AUC_ran_parents_1_ell_1[,om_H] <- AUC_average_ell_1
  res_AUC_ran_parents_1_reg[,om_H] <- AUC_average_reg
}
res_AUC_ran_parents_1
res_AUC_ran_parents_1_ell_1
res_AUC_ran_parents_1_reg

saveRDS(object = res_AUC_ran_parents_1, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_1.RDS")
saveRDS(object = res_AUC_ran_parents_1_ell_1, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_1_ell_1.RDS")
saveRDS(object = res_AUC_ran_parents_1_reg, file = "Simulations/Causal Discovery/Randomized Graph/res_AUC_ran_parents_1_reg.RDS")
